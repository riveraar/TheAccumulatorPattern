...
def run_test_count_cosines_from():
    ...
    expected = 2
    answer = count_cosines_from(0, 8, 0.85)
    ...
    expected = 9
    answer = count_cosines_from(0, 15, 0)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(10, 13, 0.75)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 4
    answer = count_cosines_from(4, 12, 0.25)
